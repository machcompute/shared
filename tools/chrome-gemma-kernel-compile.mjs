...
const cases = [
  ...
  },
  {
    ...
    label: "sliding",
    modality: "text",
    args: { HEADS: 8, KV_HEADS: 2, HEAD_DIM: 256, MAXCTX: 8192, WINDOW: 512, SUBGROUPS: 1, HEAD_BATCH: 1, ATTENTION_SCALE: 1 },
  },
  {
    name: "textFlashAttention",
    label: "decode-paired-128",
    modality: "text",
    args: { HEADS: 8, KV_HEADS: 2, HEAD_DIM: 256, MAXCTX: 8192, WINDOW: 512, SUBGROUPS: 1, HEAD_BATCH: 2, CHUNK_SIZE: 128, ATTENTION_SCALE: 1 },
  },
  {
