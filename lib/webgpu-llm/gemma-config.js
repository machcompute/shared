...
// cross-checked against the pinned GGUF. This is deliberately separate from
...
export const GEMMA_E4B_CFG = {
  ...
  revision: 'main',
  checkpoint: 'gemma-4-E4B-it-Q4_0.gguf',
  // Retained for tokenizer Cache Storage compatibility; GGUF weights use the
  // independent namespace declared in gguf/sources.js.
...
export const GEMMA_E2B_CFG = {
  ...
  checkpoint: 'gemma-4-E2B-it-Q4_0.gguf',
  // Retained for tokenizer Cache Storage compatibility; GGUF weights use the
  // independent namespace declared in gguf/sources.js.
...
// The GGUF intentionally omits repeated K/V tensors in the shared tail.
...
export const GEMMA_E4B_CHECKPOINT_HAS_PER_LAYER_KV = false;
