...
export class GemmaModel {
  ...
  #binds() {
    ...
    this.topkBind = g.bind(P.topk('all'), [b.cappedLogits, b.cand]);
    this.topkAllowedBind = g.bind(P.topk('allow'), [b.cappedLogits, b.cand, b.allowed, b.uAllowed]);
    this.topkDeniedBind = g.bind(P.topk('deny'), [b.cappedLogits, b.cand, b.allowed, b.uAllowed]);
